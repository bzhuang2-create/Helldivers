...
{   
    protected override IEnumerable<DynamicVar> CanonicalVars => [new HealVar(8), new PowerVar<RegenPower>(2)];
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play)
    {
        ...
        await PowerCmd.Apply<RegenPower>(stim.Owner.Creature, stim.DynamicVars["RegenPower"].BaseValue, stim.Owner.Creature, null);
    }
