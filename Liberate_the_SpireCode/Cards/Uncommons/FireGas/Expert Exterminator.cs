...
public class Expert_Exterminator() : Liberate_the_SpireCard(1, CardType.Skill, CardRarity.Uncommon, TargetType.AnyEnemy)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => 
        [new PowerVar<StrengthPower>(1), new RepeatVar(6)];
