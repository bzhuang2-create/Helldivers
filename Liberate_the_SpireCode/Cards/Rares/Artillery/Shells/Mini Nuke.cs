...
public class Mini_Nuke() : Liberate_the_SpireCard(1, CardType.Attack, CardRarity.Token, TargetType.AllEnemies)
{
    ...
    {
        this.DynamicVars.Poison.UpgradeValueBy(10M);
    }
}