...
namespace Liberate_the_Spire.Liberate_the_SpireCode.Cards.Commons;
...
{   
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DamageVar(4, ValueProp.Move), new CardsVar(2)];
