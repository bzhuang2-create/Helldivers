...
public class Hover_Pack() : Liberate_the_SpireCard(1, CardType.Skill, CardRarity.Common, TargetType.Self)
{   
    ...
    {
        this.DynamicVars.Block.UpgradeValueBy(6);
    }
